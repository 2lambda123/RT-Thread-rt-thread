...
#define PLIC_PRIORITY(id)               (C906_PLIC_PHY_ADDR + PLIC_PRIORITY_OFFSET + (id) * 4)
#define PLIC_PENDING(id)                (C906_PLIC_PHY_ADDR + PLIC_PENDING_OFFSET + ((id) / 32))
#define PLIC_ENABLE(id)                (C906_PLIC_PHY_ADDR + PLIC_ENABLE_OFFSET + ((id) / 32))
